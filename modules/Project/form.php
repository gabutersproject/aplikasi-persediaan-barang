...
<section class="content-header">
  <h1>
    <i class="fa fa-sign-in icon-title"></i> Data Project

    <a class="btn btn-primary btn-social pull-right" href="?module=project" title="KEMBALI" data-toggle="tooltip">
      <i class="fa-arrow-circle-left "></i> Kembali
    </a>
  </h1>
