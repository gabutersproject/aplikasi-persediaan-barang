...
if ($_GET['form']=='add') { ?> 
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="?module=supplier">  </a></li>
        ...
        <div class="box box-primary">
          ...
          <form role="form" class="form-horizontal" action="modules/supplier/proses.php?act=insert" method="POST">
            <div class="box-body">
              ...
              $query_id = mysqli_query($mysqli, "SELECT RIGHT(kd_supplier,6) as kode FROM supplier
                                                ORDER BY kd_supplier DESC LIMIT 1")
                                                or die('Ada kesalahan pada query tampil kd_supplier : '.mysqli_error($mysqli));
              ...
              $kode_supplier = "B$buat_id";
              ?>

              <div class="form-group">
                <label class="col-sm-2 control-label">Kode Supplier</label>
                <div class="col-sm-5">
                  <input type="text" class="form-control" name="kd_supplier" value="<?php echo $kode_supplier; ?>" readonly required>
                </div>
              </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-5">
                  <input type="text" class="form-control" name="norek" autocomplete="off" required>
                </div>
              </div>  
...
elseif ($_GET['form']=='edit') { 
  if (isset($_GET['id'])) {
      ...
      $query = mysqli_query($mysqli, "SELECT kd_supplier,nama_supplier,alamat,telp,norek FROM supplier WHERE kd_supplier='$_GET[id]'") 
          ...
          <form role="form" class="form-horizontal" action="modules/supplier/proses.php?act=update" method="POST">
            <div class="box-body">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label">Kode Supplier</label>
                <div class="col-sm-5">
                  <input type="text" class="form-control" name="kode_supplier" value="<?php echo $data['kd_supplier']; ?>" readonly required>
                </div>
              </div>
            ...
            <div class="form-group">
                <label class="col-sm-2 control-label">No Telp</label>
                <div class="col-sm-5">
                  <input type="text" class="form-control" name="no_telp" autocomplete="off" value="<?php echo $data['telp']; ?>" required>
                </div>
              </div>
               ...
               <div class="form-group">
                ...
                <div class="col-sm-5">
                  <input type="text" class="form-control" name="norek" autocomplete="off" value="<?php echo $data['norek']; ?>" required>
                </div>
              </div>
