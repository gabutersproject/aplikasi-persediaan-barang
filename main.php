...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Admin Panel | Aplikasi Persediaan Barang</title>
    <meta content='width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no' name='viewport'>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <meta name="description" content="Aplikasi Persediaan barang ">
    <meta name="author" content="Muhammad Amir" />
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="?module=beranda" class="logo">
          ...
          <h4 style="margin-top:7px"><b> Aplikasi Persediaan Barang </b></h4>
      ...
      <footer class="main-footer">
        <strong>Copyright &copy; 2020 - <a href="facebook.com/kumpulankode">Aplikasi Persediaan Barang</a>.</strong>
      </footer>
    </div><!-- ./wrapper -->
